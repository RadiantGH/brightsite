    ...
    return (
        <div className='main-content'>
            ...
            <p>
                ...
                <br/><br/>
                My latest projects include <a href='/lint' className='url'>SeeQR</a>, a SQL query analytics and optimization tool I worked on under OSLabs - and <a href='/worm' className='url'>Nydus</a>, my tag based media organization app inspired by Hydrus Network.
                <br/><br/>
